# from https://arxiv.org/abs/1606.01305
from tensorflow.keras import backend as K
from tensorflow.keras.layers import LSTM, time_distributed_dense
from tensorflow.keras import initializations, activations, regularizers
